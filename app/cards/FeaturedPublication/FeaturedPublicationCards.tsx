...
interface FeaturedPublicationCardsProps {
    data: featuredPublicationListData;
    key: number;
}

const FeaturedPublicationCards: React.FC<FeaturedPublicationCardsProps> = ({ data, key }) => {
    // console.log(data)
    ...
    return (
        <>
            <div className="col-md-4 px-2 mb-5 pt-0 pb-3 mx-0 d-flex align-items-center justify-content-center" key={key}>
                        ...
                        <div className={`${styles.card_content}`}>
                            ...
                            <div className="row">
                                <div className="col-7 d-flex align-items-start flex-column justify-content-end pb-2 ps-4 pe-0" style={{ marginTop: '-10px' }}>
                                    ...
                                    <p className="card-text text-secondary mb-0">{moment(data?.creation).format('MMM. YYYY')}</p>
